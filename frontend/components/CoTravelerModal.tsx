...
export const CoTravelerModal: React.FC<CoTravelerModalProps> = ({
  ...
  const content = (
    <div className={`relative w-full rounded-3xl bg-white shadow-2xl border border-slate-200 flex flex-col overflow-hidden text-slate-900 font-sans ${isInline ? "shadow-md" : "max-w-xl max-h-[88vh]"}`}>
      {/* Header */}
